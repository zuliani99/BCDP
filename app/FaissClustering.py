...
Original file is located at
    https://colab.research.google.com/drive/1F4gOJbvy4WcVxlHTi97Qrsw9jdutp5Xv
"""
...
class FaissClustering():
    ...
    def precision(prediction, target):
        ...
        @input:
            int vector prediction: contains only the values -1 and 1, predicted sentiment for all sentences
            int vector target: contains only the values -1 and 1, actual sentiment for all sentences
        @output:
    ...
    def F1(prediction, target):
        ...
        precision = precision(prediction, target)
